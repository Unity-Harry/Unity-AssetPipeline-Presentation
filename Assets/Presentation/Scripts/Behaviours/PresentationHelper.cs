...
#region Unity callbacks
        ...
        private void OnGUI()
        {
            ...
            {
                keyHandled = true;
                if ((Event.current.keyCode == PreviousSlide || Event.current.keyCode == KeyCode.PageDown) && Previous != null) 
                {
                    Event.current.Use();
                    Previous(this, EventArgs.Empty);
                }
                else if ((Event.current.keyCode == NextSlide || Event.current.keyCode == KeyCode.PageUp) && Next != null) 
                {
                    Event.current.Use();
